...
import {
    PAYMENT_OPTIONS, PRODUCT_CATEGORIES, PRODUCT_TYPE_OPTIONS, PROMOTIONAL_OPTIONS,
    STOCK_STATUS_OPTIONS, UNITS_OPTIONS
    ...
    <Spring className="card flex-1 xl:py-10">
      ...
      <form className="grid grid-cols-1 items-start gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(0,550px)] xl:gap-10">
        <div>
          <div>
            ...
            <div className="grid grid-cols-2 gap-5 md:grid-cols-4 2xl:grid-cols-[repeat(5,minmax(0,1fr))]">
              <Controller
                ...
                defaultValue=""
                render={({ field }) => (
                  <DropFiles wrapperClass="media-dropzone 2xl:col-span-2" onChange={(files) => field.onChange(files)}>
              ...
              <div className="grid grid-cols-2 col-span-2 gap-5 2xl:col-span-1 2xl:grid-cols-1">
                <Controller
                  ...
                  defaultValue=""
                  render={({ field }) => (
                    <DropFiles wrapperClass="media-dropzone" onChange={(files) => field.onChange(files)}>
                      <MediaDropPlaceholder />
                    </DropFiles>
                  )}
                />
          ...
          <div>
            <button className="text-btn mt-4 mb-2.5">More Gallery Options</button>
            <p>
          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,205px)]">
              ...
              <div className="field-wrapper">
                ...
                <input
                  className={classNames('field-input', { 'field-input--error': errors.dimensions })}
                  id="dimensions"
              ...
              <div className="field-wrapper">
                ...
                <input
                  className={classNames('field-input', { 'field-input--error': errors.weight })}
                  id="weight"
