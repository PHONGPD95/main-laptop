...
const MainProfileInfo = () => {
  ...
  return (
    <Spring className="card flex flex-col gap-4 md:flex-row md:gap-[26px] lg:col-span-3 xl:col-span-2 2xl:col-span-1">
      ...
      >
        <Image className="h-20 w-auto ml-2.5" src={theme === 'light' ? light : dark} alt="ShopPoint" />
        <span className="font-heading font-bold text-xl leading-[1.1] text-header">ShopPoint</span>
      </div>
      ...
      <Submenu anchorEl={anchorEl} open={open} onClose={handleClose}>
        <div className="flex flex-col items-start gap-5 p-5">
          <Link className="menu-btn subheading-2" href="/seller-profile">
